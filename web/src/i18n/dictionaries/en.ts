...
const en = {
  ...
  "intake.mobile": "Family contact number",
  "intake.center": "Center",
  "intake.photo": "Photo",
  "intake.capturePhoto": "Take photo",
  "intake.retakePhoto": "Retake",
  "intake.recordVoice": "Record voice sample",
  "intake.voiceRecorded": "Voice recorded",
  "intake.secretQ": "Secret question (anti-impersonation)",
  ...
  "case.title": "Case",
  "case.announcement": "PA announcement",
  "case.generateAnnouncement": "Make announcement",
  "case.playAnnouncement": "Play aloud",
  "case.voiceSamples": "Voice samples",
  "case.noVoice": "No voice samples yet",
  "case.verify": "Verify family",
  "case.verifyPrompt": "Ask the secret question and enter the answer:",
  "case.markReunited": "Mark reunited",
  "case.markHospital": "Send to hospital",
  "case.details": "Details",

  "map.title": "Live map",
  "map.hotspots": "Risk hotspots",
  "map.police": "Police stations",
  "map.cctv": "CCTV",
  "map.openCases": "Open cases",
  "map.legend": "Legend",
  "map.helpHere": "Nearest help",

  "admin.title": "Control room",
  "admin.totalCases": "Total cases",
  "admin.reunionRate": "Reunion rate",
  "admin.avgResolution": "Avg time to reunite",
  "admin.openCases": "Open now",
  "admin.byCenter": "By center",
  "admin.byLanguage": "By language",
  "admin.topHotspots": "Top risk hotspots",
  "admin.events": "Live activity",
  "admin.purge": "Run privacy purge",
  "admin.matches": "Match links",
  "admin.hours": "h",

  "sync.queued": "{n} report(s) waiting to sync",
  "sync.syncing": "Syncing…",
  "sync.offlineNote": "You are offline. Reports are saved on this device and will sync automatically.",
};
